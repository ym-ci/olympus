...
export function ClassroomIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path opacity="0.2" fill="#FFFFFF" enableBackground="new    " d="M539.5,0h-500C17.7,0,0,17.7,0,39.5v3.3C0,21,17.7,3.3,39.5,3.3
		h500c21.8,0,39.5,17.7,39.5,39.5v-3.3C578.9,17.7,561.3,0,539.5,0z"/>
      <path opacity="0.2" fill="#BF360C" enableBackground="new    " d="M539.5,496.7h-500C17.7,496.7,0,479,0,457.2v3.3
      ...
      <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="154.8649" y1="295.747" x2="154.8649" y2="282.6343" gradientTransform="matrix(12.992 0 0 -4 -1584.6235 1631.0867)">
        ...
        <stop offset="1" style={{ stopColor: "#BF360C", stopOpacity: 0.02 }} />
      </linearGradient>
      ...
      <path opacity="0.2" fill="#FFFFFF" enableBackground="new    " d="M52.6,447.4h473.7v3.3H52.6V447.4z" />
