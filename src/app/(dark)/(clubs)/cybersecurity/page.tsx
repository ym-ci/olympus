            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <div className="flex flex-col gap-2">
                  <p>
                    <strong>Junaid Mahmood:</strong>{" "}
                    junaid.mahmood@student.tdsb.on.ca
                  </p>
                  <p>
                    <strong>Benjamin P.:</strong>{" "}
                    benjamin.pourmanouchehri@student.tdsb.on.ca
                  </p>
    ...
    <main className="h-screen snap-y snap-mandatory overflow-y-scroll">
      ...
      >
        ...
        <div className="flex flex-row gap-2 place-self-center pt-4">
          <Link
            href="https://classroom.google.com/c/NjEyOTI0NTU4NTQw?cjc=3c3sijp"
            target="_blank"
          >
            <Button size={"xl"}>Join!</Button>
          </Link>
