    ...
    <section className="container mx-auto px-4 py-24">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-[auto_auto_auto] lg:gap-6">
        ...
        <InfoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between min-h-[300px]" delay={0.1}>
          ...
          <div className="mt-8">
             <Link href="https://drive.google.com/file/d/1eXMj98V5ooJi2svRK6jVt4r2HUObVqS_/view?usp=drive_link" target="_blank">
              <Button variant="link" className="p-0 text-blue-400 hover:text-blue-300 text-lg">
                Read more on the official document <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>
        </InfoCard>
          ...
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="flex items-center gap-6">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-300">Sign up before <span className="text-white font-semibold">April 26th, 2026</span> to secure your spot.</p>
              </div>
            </div>
