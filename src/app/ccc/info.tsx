    ...
    <section className="relative overflow-hidden">
      <div className="relative px-4 py-16 mx-auto max-w-4xl">
        <Card className="w-full max-w-2xl mx-auto backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border-white/20 shadow-xl">
          ...
          <CardFooter className="flex flex-col md:flex-row w-full justify-center gap-4 pt-4 border-t border-white/10">
            ...
            <Link href="#details" className="w-full md:w-fit">
              <Button
                variant="ghost" 
                className="text-white/90 hover:text-white hover:bg-white/10 font-medium px-6 py-2 w-full md:w-fit"
              >
